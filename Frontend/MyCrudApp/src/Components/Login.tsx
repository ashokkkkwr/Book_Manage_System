    ...
    <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
      <div className="bg-white dark:bg-gray-800 py-8 px-4 shadow sm:rounded-lg sm:px-10 scale-in">
        <form className="space-y-6" onSubmit={handleLogin}>
          ...
          <div className="flex items-center justify-between">
            {/* <div className="flex items-center">
              ...
              />
              <label htmlFor="isStaff" className="ml-2 block text-sm text-gray-900 dark:text-gray-300">
                Staff login
              </label>
            </div> */}
        ...
        <div className="mt-6">
          ...
          <Link to="/adminLogin" className="font-medium text-indigo-600 hover:text-indigo-500 dark:text-indigo-400 dark:hover:text-indigo-300">
          Login as Admin
        </Link>
          </div>
        </div>
